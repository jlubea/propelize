...
extern MagickExport ssize_t
  ...
  FormatLocaleString(char *__restrict__,const size_t,const char *__restrict__,...)
    magick_attribute((format (printf,3,4))),
  FormatLocaleStringList(char *__restrict__,const size_t,const char *__restrict__,
