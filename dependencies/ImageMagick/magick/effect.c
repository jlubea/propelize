...
#define StatisticImageTag  "Statistic/Image"
  ...
  */
  ...
  for (y=0; y < (ssize_t) statistic_image->rows; y++)
  {
    ...
    register IndexPacket
      *__restrict__ statistic_indexes;
