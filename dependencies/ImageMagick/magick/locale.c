...
MagickExport ssize_t FormatLocaleFile(FILE *file,const char *__restrict__ format,
  ...)
{
  ssize_t
    n;
...
MagickExport ssize_t FormatLocaleStringList(char *__restrict__ string,
...
MagickExport ssize_t FormatLocaleString(char *__restrict__ string,
...
%
*/
MagickExport double InterpretLocaleValue(const char *__restrict__ string,
  char **__restrict__ sentinal)
{
  double
    value;
